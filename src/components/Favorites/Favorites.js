            ...
            <div className="favorites">
                ...
                <ul className="favorites__list">
                    {this.state.favorits.map((item) => {
                        return <li className="remove_favorites" key={item.id}><div>{item.title} ({item.year})</div><button className="remove_button" onClick={() => this.deleteBut(item.id)}>X</button></li>;
                    })}
